...
> - JavaScript đã được trình duyệt thực thi khi trang web được tải
...
> - CSS: tạo giao diện cho trang web
...
> - Xin chào, mình là Duy, năm nay mình 24 tuổi.
> - Nếu em quên dấu `;` hoặc quên dấu `+`, điều gì xảy ra? Trình duyệt báo lỗi thế nào?
> - Thiếu dấu ";" chương trình vẫn chạy, thiếu dấu "+" chương trình lỗi
> - Chương trình thông báo lỗi thiếu dấu ngoặc ")"
...
Đọc lỗi Tra google, sử dụng tool debug 
---
...
> - Khi nào chương trình in `"Giỏi"`? score >= 8 in "Giỏi"
> - Khi nào chương trình in `"Yếu"`? Không thỏa mãn các điều kiện 
> - Em hãy mô tả cấu trúc `if/else` bằng lời của em (có thể ví von “ngã rẽ” trong đời sống):
> - if/else là câu lệnh rẽ nhánh
> - if( điều kiện thỏa mãn ){
> - trả ra kết quả mong muốn
> - } else {
> - Trả ra kết quả khác trái với điều kiện thỏa mãn 
> - }
> - Ví dụ dựa trên sự kiện có thật hôm 03/03/20026
> - if (Giá vàng tăng){
> -    trả kết quả bán chốt lời
> - }else{
> -   giữ vàng đợi lên đỉnh bán 
> - }
---
...
>   - Tên hàm: Là tên dùng để gọi và nhận diện hàm trong chương trình
>   - Tham số (parameters): Là các giá trị đầu vào được truyền vào hàm để hàm xử lý
>   - Thân hàm (body): Là khối lệnh bên trong hàm, chứa các câu lệnh thực hiện công việc của hàm.
>   - Giá trị trả về (return): Là kết quả mà hàm trả lại sau khi thực hiện xong
...
> - khi chuột click =vào phần tử 
> - Trong đoạn code trên, khi nhấn nút `btnHello`, điều gì thay đổi trên trang?
> - sự kiện thay đổi "Chưa có tương tác..." thành "Xin chào! Đây là nội dung được thay đổi bằng JavaScript."
...
> - Có, thay "red" thành "lightblue"
> - Em hãy ghi lại 1 ví dụ khác mà JavaScript có thể làm với `document.body.style`.
> - document.body.style.color = "blue"; đổi màu chữ
> - document.body.style.fontSize = "20px"; đổi cỡ chữ
---
...
> - Xảy ra liên tục mỗi khi nội dung trong ô input thay đổi, hiển thị đoạn text "Xin chào, " + (nội dung nhập) + "!"
